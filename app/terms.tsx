...
const SECTIONS = [
  ...
  },
  {
    ...
    body: 'PsychoTechniPlus מספקת פלטפורמת תרגול והכנה לבחינות פסיכוטכניות. השירות כולל שאלות תרגול, סימולציות, מעקב התקדמות ותוכן חינוכי. האפליקציה אינה גוף רשמי, אינה קשורה לצה״ל, למוסדות מיון, למעסיקים או לגורמי בחינה, ואינה מבטיחה ציון, קבלה, שיבוץ או תוצאה מסוימת.',
  },
  {
    title: '3. חשבון משתמש',
  ...
  },
  {
    ...
    body: 'רכישות מתבצעות דרך Apple App Store ובאמצעות מערכת הרכישות בתוך האפליקציה. מחיר, תקופה ותנאי החידוש מוצגים במסך הרכישה לפני האישור. מנויים מתחדשים אוטומטית אלא אם ביטלת לפחות 24 שעות לפני תום התקופה. ניתן לנהל ולבטל מנויים דרך הגדרות החשבון ב-App Store.',
  },
  {
    title: '6. הגבלת אחריות',
    body: 'השירות מסופק "כפי שהוא". איננו מתחייבים שהשירות יהיה זמין ללא הפרעות, או שהתוכן יהיה זהה למבחן רשמי כלשהו. שאלות, הסברים וציונים באפליקציה נועדו לתרגול וללמידה בלבד. לא נישא באחריות לכל נזק ישיר או עקיף הנובע משימוש בשירות.',
  },
  {
  ...
  {
    title: '8. יצירת קשר',
    body: 'לשאלות בנוגע לתנאי השימוש, פנה אלינו בכתובת: mrmedico111@gmail.com',
  },
];
