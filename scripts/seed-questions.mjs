...
const RAW = [
  ...
  { topicId:'topic_quantitative', prefix:'quant', questionType:'multiple_choice', difficulty:4,
    text:'בקופה יש מטבעות של 1 ₪, 5 ₪ ו-10 ₪. יש 20 מטבעות בסכום כולל של 102 ₪. מספר מטבעות ה-1 ₪ שווה למספר מטבעות ה-5 ₪. כמה מטבעות של 10 ₪ יש?',
    a:'4', b:'5', c:'6', d:'8', correct:'c',
    explanation:'נסמן n כמספר מטבעות ה-1₪ וגם כמספר מטבעות ה-5₪, ו-k כמספר מטבעות ה-10₪. מתקבל 2n+k=20 וגם 6n+10k=102. מציבים k=20-2n: 6n+10(20-2n)=102 → 200-14n=102 → n=7, ולכן k=20-14=6.' },

  { topicId:'topic_quantitative', prefix:'quant', questionType:'multiple_choice', difficulty:4,
    text:'מהו המספר השלם הגדול ביותר שגדול מ-5, קטן מ-10 ומתחלק ב-3?',
    a:'5', b:'6', c:'8', d:'9', correct:'d',
    explanation:'המספרים בין 5 ל-10 הם 6, 7, 8, 9. המספרים שמתחלקים ב-3 הם 6 ו-9, והגדול מביניהם הוא 9.' },
  ...
  { topicId:'topic_quantitative', prefix:'quant', questionType:'multiple_choice', difficulty:6,
    ...
    a:'2 שעות ו-24 דקות', b:'4 שעות', c:'6 שעות', d:'12 שעות', correct:'a',
    explanation:'A ממלא 1/3 לשעה, B ממלא 1/4 לשעה, C מרוקן 1/6 לשעה. נטו: 1/3+1/4-1/6 = 4/12+3/12-2/12 = 5/12 בריכה לשעה. הזמן הוא 1÷(5/12) = 12/5 = 2.4 שעות = 2 שעות ו-24 דקות.' },

  { topicId:'topic_quantitative', prefix:'quant', questionType:'multiple_choice', difficulty:6,
    text:'שלושה צינורות ממלאים בריכה. A ב-3 שעות, B ב-4 שעות, C (ניקוז) ב-6 שעות. כמה זמן ייקח לשלושתם יחד?',
    a:'2 שעות ו-24 דקות', b:'שעה ו-12 דקות', c:'3 שעות', d:'4 שעות', correct:'a',
  ...
  { topicId:'topic_quantitative', prefix:'quant', questionType:'multiple_choice', difficulty:7,
    ...
    a:'60', b:'1140', c:'6840', d:'380', correct:'b',
  ...
  { topicId:'topic_logic', prefix:'logic', questionType:'logic', difficulty:6,
    ...
    a:'1/2', b:'1/3', c:'1/6', d:'5/12', correct:'a',
    explanation:'בוחרים חדר באקראי, לכן לכל חדר הסתברות 1/3. בחדר א׳ ההסתברות לאדום היא 1, בחדר ב׳ היא 1/2, ובחדר ג׳ היא 0. לכן P(אדום)=1/3×1 + 1/3×1/2 + 1/3×0 = 1/3+1/6 = 1/2.' },
