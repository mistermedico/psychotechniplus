-- PsychoTechniPlus admin sync migration
-- Run once in Supabase SQL Editor for project kdnkrvltgptiffxkclyg.
...
select
  ...
  to_regclass('public.admin_state') is not null as has_admin_state;
